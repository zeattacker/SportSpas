...
public class WelcomeAdapter extends PagerAdapter {
	...
	class generateData extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			...
			dh.addMP(new MultipleQuizModel("Federballschläger", "10", "img_sport_5",
			...
			//True Or False Text
			dh.addTF(new TFQuizModel("img_alat_7", "Ball für Fußball genutzt", 0));
			dh.addTF(new TFQuizModel("img_alat_7", "Ball für Fußball genutzt 2", 0));
			dh.addTF(new TFQuizModel("img_sport_5", "Das Spiel Fußball 3", 1));
			dh.addTF(new TFQuizModel("img_sport_5", "Das Spiel Fußball 4", 1));
			dh.addTF(new TFQuizModel("img_alat_7", "Ball für Fußball genutzt 5", 0));
			dh.addTF(new TFQuizModel("img_alat_7", "Ball für Fußball genutzt 6", 0));
			dh.addTF(new TFQuizModel("img_sport_5", "Das Spiel Fußball", 1));
			dh.addTF(new TFQuizModel("img_sport_5", "Das Spiel Fußball 8", 1));
			dh.addTF(new TFQuizModel("img_alat_7", "Ball für Fußball genutzt 9", 0));
