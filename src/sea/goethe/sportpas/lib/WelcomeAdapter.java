...
public class WelcomeAdapter extends PagerAdapter {
	...
	class generateData extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			...
			dh.addMP(new MultipleQuizModel("img_alat_3", "10", "Fuﬂballplatz",
			...
			//air
			dh.addMP(new MultipleQuizModel("die Flˆﬂerei", "10", "img_sport_9",
			...
			dh.addMP(new MultipleQuizModel("img_alat_12", "20", "das Gleitschirmfliegen",
					"der Heiﬂluftballon", "der Flugzeug", "das Segelflugzeug", 0, "udara"));
			dh.addMP(new MultipleQuizModel("img_alat_14", "20", "ob Heiﬂluftballon zum Luft ?",
					"", "", "", 0, "udara"));
			...
			dh.addLearn(new LearnModel("der Fubﬂall", "Ich Spiele Fubﬂall", "img_sport_7",
			...
			dh.addLearn(new LearnModel("die Flˆﬂerei", "Ich bin Flˆﬂerei", "img_sport_10",
			...
			dh.addLearn(new LearnModel("der Heiﬂluftballon", "Ich leihe Heiﬂluftballon", "img_alat_14",
